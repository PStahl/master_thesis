...
Monitoring the system is crucial to achieve an entirely dynamic system, in which certain reliability is dynamically ensured. One must know where replicas are executing and be able to detect node failures and store the time of failure.
