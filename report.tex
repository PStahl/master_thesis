	...
	\begin{tabular}{| c | c | c | c | c |}
	 ...
	 \hline
	  ...
	  10 s & 107.3 & 597 & 34 & 194.5 \\ %times the actual exceeded 115
	   \hline
	\end{tabular}
	 \caption[Average $t_{\textrm{R}}$, number of times above 100 ms and 500 ms and the 95th percentile in~\cref{sec:eval_time_t}]{Average time $t_{\textrm{R}}$, number of times above 100 ms and 500 ms, and the 95th percentile value for \emph{MTBF} 30 and 10 in~\cref{sec:eval_time_t}}
	 \label{table:tr}
	 \end{center}
 \end{table} 
