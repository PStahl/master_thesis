...
The time $t$ used in \label{eq:desired_rel} can be expressed as the time it takes from that a failure happened, until a new replica is operational. We can therefore express t as
...
\subsection{Failure detection time}
