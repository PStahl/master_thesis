...
An application in Calvin consist of a set of connected \emph{actors}. An actor usually represents part of a devise, service or computation. Actors communicate by sending data on their outports to other actors inports.  %TODO
