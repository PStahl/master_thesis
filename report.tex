...
Since all nodes are interconnected we have redundant paths which results in that all nodes are directly reachable even if a node fails. In Appendix \cite{appendix:___TODO___} a system of one replicated actor is shown before and after a node failure.
