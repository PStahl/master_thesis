...
\\\\
Checkpointing is a fault-tolerance technique which periodically saves the state of a computation to a persistent storage \cite{relGridSystems}. In the case of failure, a new process can be restarted from the last saved state, thereby reducing the amount of computations needed to be redone.
