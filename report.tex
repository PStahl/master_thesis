...
Where $t_i$ are the numbers following the normal distribution, and $T_{elapsed}$ is the total elapsed time for the test. Given $t_i=25$, the ~\autoref{fig:eval_sleep_time} shows how the actual time to sleep varies over time.
