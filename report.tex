...
In contrast to having a primary task and back-up replicas there's also the case when all replicas behaves as the primary. In this case all replicas have to produce output.
