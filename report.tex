...
Reliability of a system highly depends on how the system is used \cite{surveyRelPrediction}. When modeling a system's reliability, one must take all factors into account in order to create a proper model. However, with the vast number of factors affecting a system's reliability, it is practically unfeasible. 
