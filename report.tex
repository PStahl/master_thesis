...
Calvin
Also wraps up all necessary components to run the actors anywhere? All different actors are embedded in the runtime. The runtimes seperate the hardware from the software in order to be able to use Calvin on different platforms. At developing phase, no need of considering on which operating system the application should run.
