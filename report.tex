...
In order to validate our model, we conducted a set of experiments. These goal of the experiments were to show that our model supports dynamic ensurance of reliability, and doing so in an optimal way by chosing the most reliable nodes.
