...
Secondly, a framework will be designed which will automatically detect node failures and spawn enough replicas to reach above the desired reliability level.
