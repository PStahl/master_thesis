...
For reliability modelling for the grid, it is common to also assume a fully reliable Resource Management System (RMS)~\cite{relAndPerfGridServices, relGridServicePredConstraint}, which is an non-negligible-able assumption since the RMS in this case in fact is a single point of failure.
