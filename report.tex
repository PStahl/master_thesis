...
In the experiments conducted, see \cref{ch:evaluation}, heartbeats were sent to all nodes in the system every 200 ms. Furthermore, a node is considered dead when no heartbeat is received for 500 ms. These values should be modified in a real setting. For the experiments, a high-bandwidth low-latency cluster was used, why the frequency could be quite high and the timeout time relatively low. 
