...
On the sixth server, two runtimes were started, which were not killed. One of these stable runtimes was used as a proxy storage, further described in~\cref{sec:eval_storage}. The reason for having the other stable runtime is described in~\cref{sec:eval_application}.

In the experiments, the runtimes are referred to as nodes.
