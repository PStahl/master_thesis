...
\begin{function} 
	...
	Returns the given nodes in sorted order, with the most preferred nodes first. We only consider the nodes' reliability when sorting, but it can easily be changed to consider other parameters as well.
	\begin{algorithmic}[1]
