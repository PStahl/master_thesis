...
The replication time is stored per task type. Since the state of different types of tasks vary, and thereby the size of the states, the time to send the state from one node to another will also vary. 

%TODO example that the number of replicas vary for various tasks depending on their T_R?
...
\subsubsection{Increasing variable size}
...
\subsubsection{Increasing queue size}
