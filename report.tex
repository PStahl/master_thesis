...
The test was considered successful if, when the current reliability dropped below the required it was restored to a level above the required. %TODO Maybe better?
