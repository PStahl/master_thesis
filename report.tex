...
Adaption refers to changing the behaviour depending on the changing state of the system. For a distributed system, resources must be continuously monitored in order to adapt to changing behaviour~\cite{imprRelAdaptRL}.
...
\iffalse
TODO: If we have time: - we didn't :) 
