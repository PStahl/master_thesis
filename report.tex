...
\subsubsection*{Result}
\Cref{fig:replication_time} shows how the replication time vary depending on the state size. The replication time is clearly linear in relation to the size of the state.
