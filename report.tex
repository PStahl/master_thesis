...
\section{Methodology}
%TODO
The methodology for developing our model is literature study. Apart from this we have also had meetings and discussions with both our supervisor but also colleges at MAPCI. Since a lot of test were already written to the Calvin system a test-driven development of our code came natural.

\section{Överblick över hela modellen} %I think a section would be good here, change name of section
...
The rest of this chapter is composed as follows, in \ref{sec:system_model} we describe our System Model more in detail, e.g. in which computational environment we test our model, how we model the faults... etc. In \ref{sec:reliability_model} we present our reliability model, which is our main contribution with this paper. We state diverse definitions, a scheduling algorithm and a self-adapting model. Last in this chapter \ref{sec:implementation} we briefly describe how we have implemented our model.
