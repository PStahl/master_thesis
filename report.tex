...
One way of increasing the reliability is by the use of replication. Replicating a results in increased redundancy, and allows for continued execution of the application, despite the event of failure of a replica task. Seamlessly being able to continue the execution or processing of events, without losing any data is of particular interest in data stream processing.
