...
\subsubsection{Storage} \label{ch:calvin_storage}
...
\caption{After Node C has failed. Now three replicacs (placed on Node A, B and D) is reuiqred to achieve reuiqred reliability.} \label{fig:before_node_failure}
\end{figure}
