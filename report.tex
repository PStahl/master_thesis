...
\subsubsection*{Result}
%TODO remove reference to number of replicas graph?? Do not show in this experiment?
The experiment ran for 5 minutes, and \autoref{fig:exp_reliability_level} shows how the reliability vary during this period. \autoref{fig:exp_reliability_level_replicas} shows the number of replicas used over time. The average reliability for the duration of the whole test was 0.997, clearly above the desired level of 0.98.
